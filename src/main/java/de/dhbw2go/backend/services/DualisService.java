...
public class DualisService {
    ...
    //@Autowired
    private final DualisRequester dualisRequester = new DualisRequester();

    public DualisCookie login(final String username, final String password) {
    ...
    public List<DualisSemesterModel> getSemesters(final DualisCookie dualisCookie) {
    ...
    public DualisSemesterModel getSemester(final DualisCookie dualisCookie, final String semesterReferenceArguments) {
    ...
    public DualisOverviewModel getOverview(final DualisCookie dualisCookie) {
    ...
    public List<DualisExamModel> getExams(final DualisCookie dualisCookie, final String examsReferenceArguments) {
